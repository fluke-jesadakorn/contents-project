...
import { cockpitProjectionPrompt, salesExtractPrompt, customerCreditPrompt, getTileSystemPrompt, renderLocaleAwarePrompt } from '@/ai/systemPrompts';
import { query } from '@/db';
import { getSecondaryLocaleFromHeaders } from '@/server/locale';
