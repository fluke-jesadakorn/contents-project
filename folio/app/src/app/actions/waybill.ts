...
import { z } from 'zod';
import { withTransaction, query as _query } from '@folio-lib/db';
import { recordEvent } from '@folio-lib/waybill/events';
import { recordAttachment, getAttachment } from '@folio-lib/waybill/attachments';
import { loadWaybill, domainOf, loadApproversByStage } from '@folio-lib/waybill/queries';
import { allowedKindsFor, type WaybillAttachmentKind } from '@folio-lib/waybill/kinds';
import { addWatcher, removeWatcher } from '@folio-lib/waybill/watchers';
import { reCallWaybillAction } from '@folio-lib/waybill/recall';
import { resolveNextStage } from '@folio-lib/perm/server';
import { matchPerm } from '@folio-lib/perm';
import { loadActor, type ActorWithScope } from '@folio-lib/server/guard';
import { ensureGlForExpense, ensurePoForExpense as ensurePoForExpenseWithClient } from '@folio-lib/waybill/ensureArtifacts';
import { ensurePoPdf } from '@folio-lib/finance/poPdf';
import { upsertDraftJournal, finalizeDraftJournal, setExpenseJournalEntry } from '@folio-lib/finance/postExpenseToGL';
import { upsertProcurementDraftAccrual } from '@folio-lib/finance/postProcurementToGL';
import { pipsForDomain } from '@folio-lib/waybill/derive';
import {
  actorForWaybill,
  canConfirmGl,
