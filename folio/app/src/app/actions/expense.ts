...
import { z } from 'zod';
import { query, withTransaction, query as _query } from '@folio-lib/db';
import { recordAttachment } from '@folio-lib/waybill/attachments';
import { recordEvent } from '@folio-lib/waybill/events';
import { loadWaybill } from '@folio-lib/waybill/queries';
import { requireActionFor } from '@folio-lib/server/requireActionFor';
import { loadActor, type ActorWithScope } from '@folio-lib/server/guard';
import { matchPerm } from '@folio-lib/perm';
import { PERM, resolveApprovalChain, type StageName, type ResolverCtx } from '@folio-lib/perm/server';
import {
  finalizeDraftJournal,
  upsertDraftJournal,
} from '@folio-lib/finance/postExpenseToGL';
import { appendWaybillEvent } from '@folio-lib/waybill/append';
import { aiInvoke } from '@folio-lib/ai/router';
import { publish as publishEvent } from '@folio-lib/notifications/events';
