...
import type { WaybillRow } from '@folio-lib/waybill/queries';
...
export function WaybillHeader({
  ...
  const formattedAmount = formatMoneyServer(wb.total_amount, localeSafe, wb.currency);
  const formattedCreated = formatDateServer(wb.created_at, localeSafe);
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-slate-400">
            ...
            <span className="inline-flex items-center gap-1.5 font-mono text-xs uppercase tracking-wider">
              <span aria-hidden>🕐</span>
              <span>
                <Bilingual en="Created" th="สร้าง" locale={localeSafe} />{' '}
