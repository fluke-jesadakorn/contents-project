...
export function FinanceRagPanel() {
  ...
  return (
    <section className="rounded-2xl border border-emerald-500/30 bg-emerald-950/15 p-5">
      <h3 className="mb-2 text-xs font-mono uppercase tracking-widest text-emerald-300">Vendor RAG</h3>
      <p className="mb-3 text-xs text-slate-500">Ask in natural language — answers cite past expense slips by similarity.</p>
      <textarea
        value={q}
