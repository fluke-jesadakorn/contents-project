...
export const PERM = {
  ...
  finance: {
    ...
    journal:          { prepare: allow('finance', 'journal', 'prepare'), approve: allow('finance', 'journal', 'approve'), reverse: allow('finance', 'journal', 'reverse'), manual: allow('finance', 'journal', 'manual') },
    coa:              { manage: allow('finance', 'coa', 'manage') },
    period:           { close: allow('finance', 'period', 'close'), reopen: allow('finance', 'period', 'reopen') },
    fx:               { manage: allow('finance', 'fx', 'manage') },
    bank:             { import: allow('finance', 'bank', 'import'), match: allow('finance', 'bank', 'match'), reopen: allow('finance', 'bank', 'reopen') },
    report:           { executive: allow('finance', 'report', 'executive'), view: allow('finance', 'report', 'view'), export: allow('finance', 'report', 'export') },
    budget:           { view: allow('finance', 'budget', 'view'), manage: allow('finance', 'budget', 'manage') },
  ...
  inventory: {
    stock: {
      view: allow('inventory', 'stock', 'view'),
      receive: allow('inventory', 'stock', 'receive'),
      ship: allow('inventory', 'stock', 'ship'),
      transfer: allow('inventory', 'stock', 'transfer'),
      count: allow('inventory', 'stock', 'count'),
      adjust: allow('inventory', 'stock', 'adjust'),
    },
  },
  stage: {
