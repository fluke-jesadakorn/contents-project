...
//   node world-erp/db/audit_route_access.mjs
...
const ROUTES = [
  ...
  { method: 'GET', path: '/submit-expense',         expect: { roles: { staff: [200], cfo: [404] }, anyOf: [200, 404] } },
  { method: 'GET', path: '/approve-expense',        expect: { anyOf: [200, 404] } },
