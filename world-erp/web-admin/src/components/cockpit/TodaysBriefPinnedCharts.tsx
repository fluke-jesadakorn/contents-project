...
const STORAGE_KEY = 'worderp.pinned_charts';
...
export function TodaysBriefPinnedCharts() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('worderp:pinned_charts', onUpdate);
    window.addEventListener('storage', onUpdate);
    return () => {
      window.removeEventListener('worderp:pinned_charts', onUpdate);
