...
import type { PipState, WaybillStagePip, WaybillDomain } from '@erp-lib/waybill/derive';
...
import type { ApproverRow, ExpenseArtifacts, ProcurementArtifacts } from '@/lib/server/waybill';
