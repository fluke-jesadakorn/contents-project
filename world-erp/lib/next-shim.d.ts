...
// lib/ is logically part of web-admin (consumed via @erp-lib/* alias) but
// lives outside web-admin/tsconfig.json's node_modules. This shim gives
// tsc the few symbols we touch without dragging in the full Next.js types.
//
// We only declare what lib/ actually references; web-admin/* uses the real
